...
<div id="topo"></div>
<div id="entrada">
<div id="top">Area do cliente - Versão 3.0.4</div>
<div id="form">
<form action="login.php" method="post" enctype="multipart/form-data">
    ...
    <input name="logar" type="submit" value="Entrar" id="logar" class="botao"> &nbsp;&nbsp;&nbsp;&nbsp;<a href="enviarsenha.php" onClick="NovaJanela(this.href,'nomeJanela','350','350','yes');return false" title="Editar">Esqueci minha senha</a> 
