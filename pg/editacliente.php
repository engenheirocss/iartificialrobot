...
$(document).ready(function() {
  ...
  <tr>
    ...
    <td colspan="2" align="left" valign="top">IE / IM:<br/>
    <input name="inscricao" type="text" value="<?php echo $l['inscricao']?>">
    </td>
    <td width="28%" align="left" valign="top">Grupo:<br/>
  ...
  <tr>
    ...
    <td colspan="2" align="left" valign="top" style="padding-left:5px;">
      ...
      <legend style="margin-left:5px;">Bloquear cliente</legend>
        <input name="bloqueado" type="radio" value="S" <?php if($l['bloqueado'] == "S"){echo "checked=\"checked\"";} ?>>Sim 
        <input name="bloqueado" type="radio" value="N" <?php if($l['bloqueado'] == "N"){echo "checked=\"checked\"";} ?>>Não    
      </fieldset>    
      </td>
    </tr>
  <tr>
