...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th width="57%" align="left" bgcolor="#66CCFF" style="margin-left:5px;"><strong>Nome</strong></th>
    <th width="8%" align="center" bgcolor="#66CCFF" style="margin-left:5px;">Situação</th>
    <th width="11%" align="left" bgcolor="#66CCFF" style="margin-left:5px;">Valor</th>
...
$cons = mysql_query("SELECT * FROM cliente WHERE nome LIKE '%$pesquisa%'") or die(mysql_error());
}
else{
$cons = mysql_query("SELECT * FROM cliente ORDER BY nome ASC");	
}
