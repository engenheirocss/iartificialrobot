...
$pg = $_GET['p']; ?>
      ...
      <?php }else{ ?>
      <a href="pg/baixamanual.php?id_venda=<?php echo $array['id_venda']; ?>&pagina=fatpendente" class="editar" title="Receber título" onclick="NovaJanela(this.href,'nomeJanela','650','450','yes');return false">Baixar</a> </span>
      <?php } ?>
    </div></td>
  </tr>
<?php } ?> 
